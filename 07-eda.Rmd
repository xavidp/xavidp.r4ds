...
Por ejemplo, el caso de la variable `clase` del conjunto de datos `millas`. Podría interesarte saber cómo varía el rendimiento en autopista según la clase del vehículo:
...
4.  Un problema con los diagramas de caja es que fueron desarrollados en un tiempo en que 
    los conjuntos de datos eran más pequeños y por ende tienden a mostrar un número muy grande de 
