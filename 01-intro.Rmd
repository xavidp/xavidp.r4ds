...
knitr::include_graphics("diagrams/data-science.svg")
```
...
```{r echo = FALSE, out.width = "75%"}
knitr::include_graphics("diagrams/rstudio-console.svg")
```
...
* Los tres capítulos sobre flujo de trabajo fueron adaptados (con permiso) de
 <http://stat545.com/block002_hello-r-workspace-wd-project.html> de
 Jenny Bryan.
...
La versión online de este libro está disponible en <http://es.r4ds.hadley.nz>. El original en inglés puedes encontrarlo en <http://r4ds.had.co.nz>. Las versiones online seguirán evolucionando entre reimpresiones del libro físico. 
