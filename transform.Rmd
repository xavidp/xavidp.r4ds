...
En este capítulo nos enfocaremos en cómo usar el paquete **dplyr**, otro miembro central de tidyverse. Ilustraremos las ideas clave con el conjunto de datos *vuelos* del paquete **datos** y usaremos **ggplot2** para ayudarnos a comprender los datos. 
