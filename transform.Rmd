...
Toma nota acerca del mensaje de conflictos que se imprime cuando carga el paquete tidyverse. Le dice que dplyr sobrescribe algunas funciones en la base R. Si desea usar la versión base de estas funciones después de cargar dplyr, necesitará usar sus nombres completos: `stats :: filter ()` y `stats :: lag () `.
