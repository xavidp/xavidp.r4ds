...
Después puedes referirte a los valores con `input$name` and `input$age`, y el código que los usa se volverá a ejecutar automáticamente cada vez que cambien.
