...
knitr::include_graphics("diagrams/es/data-structures-overview.png")
```
...
knitr::include_graphics("diagrams/es/lists-structure.png")
```
...
knitr::include_graphics("diagrams/es/lists-subsetting.png")
```
