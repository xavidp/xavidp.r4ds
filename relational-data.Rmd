...
```{r, echo = FALSE}
knitr::include_graphics("diagrams/es/relational-nycflights.svg")
```
...
knitr::include_graphics("diagrams/es/join-setup.svg")
```
```{r}
x <- tribble(
  ~ key, ~ val_x,
...
```{r, echo = FALSE, out.width = NULL}
knitr::include_graphics("diagrams/es/join-setup2.svg")
```
...
```{r, echo = FALSE, out.width = NULL}
knitr::include_graphics("diagrams/es/join-inner.svg")
```
...
```{r, echo = FALSE, out.width = NULL}
knitr::include_graphics("diagrams/es/join-outer.svg")
```
...
```{r, echo = FALSE, out.width = NULL}
knitr::include_graphics("diagrams/es/join-venn.svg")
```
...
1.  One table has duplicate keys. This is useful when you want to
    ...
    ```{r, echo = FALSE, out.width = NULL}
knitr::include_graphics("diagrams/es/join-one-to-many.svg")
    ```
...
1.  Both tables have duplicate keys. This is usually an error because in
    ...
    ```{r, echo = FALSE, out.width = NULL}
knitr::include_graphics("diagrams/es/join-many-to-many.svg")
    ```
...
```{r, echo = FALSE, out.width = NULL}
knitr::include_graphics("diagrams/es/join-semi.svg")
```

Only the existence of a match is important; it doesn't matter which observation is matched. This means that filtering joins never duplicate rows like mutating joins do:

```{r, echo = FALSE, out.width = NULL}
knitr::include_graphics("diagrams/es/join-semi-many.svg")
```

The inverse of a semi-join is an anti-join. An anti-join keeps the rows that _don't_ have a match:

```{r, echo = FALSE, out.width = NULL}
knitr::include_graphics("diagrams/es/join-anti.svg")
```
