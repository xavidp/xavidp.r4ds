...
```{r, echo = FALSE}
knitr::include_graphics("diagrams/lists-map2.svg")
```
...
```{r, echo = FALSE}
knitr::include_graphics("diagrams/lists-pmap-unnamed.svg")
```
...
```{r, echo = FALSE}
knitr::include_graphics("diagrams/lists-pmap-named.svg")
```
...
knitr::include_graphics("diagrams/lists-invoke.svg")
```
