...
```{r bool-ops, echo = FALSE, fig.cap = "Set completo de operadores booleanos. `x` es el círculo de la derecha, `y` es el círculo de la izquierda y la región sombreada qué partes selecciona cada operador."}
